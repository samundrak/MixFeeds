	...
	<li class="list-group-item">
		<div class="row">
			<div class="col-md-4">Small (10$/month)
				<br/>
				<a ng-click="subscribe('simple')" href="javascript:void(0)">Subscribe</a>
			</div>
			<div class="col-md-4">Medium (20$/month)
				<br/>
				<a ng-click="subscribe('medium')" href="javascript:void(0)">Subscribe</a>
			</div>
			<div class="col-md-4">Super (30$/month)
				<br/>
				<a ng-click="subscribe('super')"href="javascript:void(0)">Subscribe</a>
			</div>
		</div>
	</li>
	<br/>
